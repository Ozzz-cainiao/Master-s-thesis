%**************************************************************************
% 文件名: E:\坚果云同步文件夹\毕设——非合作多目标定位\FinalCode\ZLM特征关联\main5.m
% 版本: v1.0
% 作者: ZLM
% 联系方式: Liminzhang7@outlook.com
% 日期: 2024-05-22
% 描述: 与层次聚类算法进行对比 虚警率  不可用  测试层次聚类算法的划分方法
% 输入:  
% 输出:  
%**************************************************************************
...
% 查找合适的距离阈值
threshold = 0.5;  % 选择一个距离阈值


% 使用距离阈值切割树状图
groups = cluster(Z, 'cutoff', threshold, 'criterion', 'distance');
