...
[x1, y1, x2, y2, x3, y3] = deal(0, 0, 2000, 0, 1000, 2000); %% 平台位置
...
% 仿真2
% errornor = [2^2, 2^2, 0.001^2, 1.5^2]; % x y ts^2  c^2误差  假设只有测时误差  已经是平方误差了
errornor = [5^2, 5^2, 0.001^2, 1.5^2]; % x y ts^2  c^2误差  假设只有测时误差  已经是平方误差了

% 仿真3
% errornor = [2^2, 2^2, 0.001^2, 1.5^2];
% errornor = [5^2, 5^2, 0.001^2, 1.5^2];
...
% errorsum(errorsum > 50) = 50;
figure('Units', 'centimeters', 'Position', [10, 10, 7.5, 6.5]); % 左下宽高
