...
delta_x3 = normrnd(0, std_p, 1, diedai);
delta_y3 = normrnd(0, std_p, 1, diedai);
delta_x4 = normrnd(0, std_p, 1, diedai);
delta_y4 = normrnd(0, std_p, 1, diedai);
...
%% 画图
figure
plot(x(1:87), y(1:87), 'go');
hold on;
plot(no_result_x(8:94), no_result_y(8:94), 'b.');
hold on;
plot(x1, y1, 'r*');
hold on;
plot(x2, y2, 'r*');
...
plot(x(1:87), y(1:87), 'go');
hold on;
plot(x_position_MA, y_position_MA, 'r.');
hold on;
plot(x1, y1, 'r*');
hold on;
plot(x2, y2, 'r*');
