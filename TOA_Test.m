...
% pack_r_measure = pack_r_truth ; %包裹到达各个基站时的基站本地记录的时间，含有偏差
...
B(1) = (pack_r_measure(2)^2 - pack_r_measure(1)^2) * c^2 - BS2(1)^2 - BS2(2)^2 + BS1(1)^2 + BS1(2)^2; %方程相减之后，常数矩阵B
B(2) = (pack_r_measure(3)^2 - pack_r_measure(1)^2) * c^2 - BS3(1)^2 - BS3(2)^2 + BS1(1)^2 + BS1(2)^2;
B(3) = (pack_r_measure(4)^2 - pack_r_measure(1)^2) * c^2 - BS4(1)^2 - BS4(2)^2 + BS1(1)^2 + BS1(2)^2;
