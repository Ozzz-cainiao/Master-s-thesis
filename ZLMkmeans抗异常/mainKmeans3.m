%**************************************************************************
% 文件名: E:\坚果云同步文件夹\毕设——非合作多目标定位\FinalCode\ZLMkmeans抗异常\mainKmeans3.m
% 版本: v1.0
% 作者: ZLM
% 联系方式: Liminzhang7@outlook.com
% 日期: 2024-04-05
% 描述: 对kmeans抗异常参量技术进行性能分析────程序2,计算不同异常参量个数的检出率 
% 输入:
% 输出:
%**************************************************************************
...
%                 choseP(end + 1) = "theta"+num2str(b(kk, jj));
        ...
        temp = nonSubsetElementsInRes;
        % 将字符串数组排序
        sorted_str1 = sort(temp);
        sorted_str2 = sort(choseP);
        
        % 检查是否相同
        if ~isempty(temp) && isequal(sorted_str1, sorted_str2)
