...
// Date: Thu Sep 21 21:34:39 2023
// Arguments:
// "-B""macro_default""-W""cpplib:myadd,all,version=1.0""-T""link:lib""-d""E:\MP
// NP\MyMainFunction\myadd\for_testing""-v""E:\MPNP\MyMainFunction\myadd.m"
//

#define EXPORTING_myadd 1
#include "myadd.h"
    ...
    mclOutputHandlerFcn print_handler)
{
    ...
    if (!mclmcrInitialize())
        return false;
    if (!GetModuleFileName(GetModuleHandle("myadd"), path_to_dll, _MAX_PATH))
        return false;
    {
...
{
    return myaddInitializeWithHandlers(mclDefaultErrorHandler, mclDefaultPrintHandler);
}
